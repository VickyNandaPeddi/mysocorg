...
/**
 * OrgBasicDetailsResponse is to represent the response data structure of the organisation basic details
 * @author Mohamedsuhail S
 *
 */
@Getter
@Setter
public class OrgBasicDetailsResponse extends BaseResponse{
